...
| --- | ----------- | --------------------------- | ------- | --- |
| 1. | Implement RA Operators: Select, Project, Union, Minus and Join | [Table.java](summer14/Table.java), [KeyType.java](summer14/KeyType.java), [ArrayUtil.java](summer14/ArrayUtil.java) and [MovieDB.java](summer14/MovieDB.java) | Finish the implementation the 5 RA Operators that are partially implemented in Table.java. Store tuples in an ArrayList. Use a TreeMap for an index. | 6/20 |
